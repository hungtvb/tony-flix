...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'guest',
      testMatch: /auth\.spec\.ts|register\.spec\.ts|favorites\.spec\.ts|watch-progress\.spec\.ts|favorite-button\.spec\.ts|favorites-page\.spec\.ts|continue-watching\.spec\.ts|mobile-nav\.spec\.ts|change-password\.spec\.ts/,
